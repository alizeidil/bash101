...
**example :**
```bash
cd Desktop #( You are right now on the desktop. )
```
...
mkdir bash101
```
**result :** we created a new directory in the name of bash101 on the terminal
...
touch lection_1.sh
```
**result :** we created a new (shell script) file in the "bash101" directory.
